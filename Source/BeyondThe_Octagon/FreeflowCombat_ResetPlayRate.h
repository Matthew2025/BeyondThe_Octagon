...
#include "FreeflowCombat_ResetPlayRate.generated.h"

/**
 * 
 */
UCLASS()
class BEYONDTHE_OCTAGON_API UFreeflowCombat_ResetPlayRate : public UAnimNotifyState
{
	GENERATED_BODY()

	UFreeflowCombat_ResetPlayRate();
